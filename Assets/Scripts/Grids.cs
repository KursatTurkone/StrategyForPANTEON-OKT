...
public class Grids<TGridObject>
{
    ...
    public Grids(int width, int height, float cellSize, Vector3 originPosition, Func<Grids<TGridObject>, int, int, TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
